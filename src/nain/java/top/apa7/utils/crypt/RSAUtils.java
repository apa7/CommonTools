...
public class RSAUtils {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // 公匙加密
        String pubKeyStr = RSAUtils.encryptByPubKey(datastr);
        System.out.println("公匙加密:" + pubKeyStr);
        String priKeyStr = RSAUtils.decryptByPriKey(pubKeyStr);
        // 私匙解密
        ...
        String str1 = "before";
        String str2 = "after";
        String sign = RSAUtils.sign(str1.getBytes());
